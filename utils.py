...
#            # one fourth chances to do_nothing
...
#
#    img_train = datain
#    # convert to [N, num_frames*C. H, W] in  [0., 1.] from [N, num_frames, C.
#    # H, W] in [0., 255.]
...
def svd_orthogonalization(lyr):
    ...
    if classname.find('Conv') != -1:
        ...
        try:
            ...
            lyr.weight.data = weights.view(
                f1, f2, c_in, c_out).permute(3, 2, 0, 1).type(dtype)
        except:
            pass
    else:
        pass
